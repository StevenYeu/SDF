...
<ul class="nav nav-tabs nav-tabs-js" role="tablist">
    ...
    ?>
    <?php if($can_edit_resource): ?>
        <li class="pull-right"><a class="btn-u" href="<?php echo $url ?>"><i class="fa fa-pencil"></i> Edit</a></li>
    <?php endif ?>
...
<div class="tab-content">
    ...
    if (count($pmids)) {
        ...
        $url3 = Connection::environment() . '/v1/literature/pmid?pmid=' . join('&pmid=', $pmids);
