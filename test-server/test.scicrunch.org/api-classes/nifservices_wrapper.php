...
function getResponse($user, $api_key, $path) {
    if(!\APIPermissionActions\checkAction("dataservices-wrapper", $api_key, $user)) return APIReturnData::quick403();
    $url = Connection::environment() . "/v1/" . $path;
    $ch = curl_init($url);
