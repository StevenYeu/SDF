...
$popQuest = $holder->getByPopularity(104,0,0,7,true);
$techSupp = $holder->tagSearch('Technical Support',0,104,0,7);
$sourceHelp = $holder->tagSearch('Data Sources',0,104,0,7);
$commHelp = $holder->tagSearch('Community Help',0,104,0,7);
$tuts = $holder->getByPopularity(105,0,0,7,false);
$techSuppq = $holder->tagSearch('My Account',0,105,0,7);
$sourceHelpq = $holder->tagSearch('Data Sources',0,105,0,7);
$commHelpq = $holder->tagSearch('Community Help',0,105,0,7);
...
<div class="breadcrumbs-v3">
    <div class="container">
        ...
        <h1 class="pull-right">FAQs Page</h1>
    </div>
</div>
<!--=== End Breadcrumbs v2 ===-->
...
<div id="profile" class="tab-pane fade">
    <div id="accordion-v2" class="panel-group acc-v1">
        <?php
        $count = 0;
        foreach($sourceHelp['results'] as $data){?>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
...
<div id="messages" class="tab-pane fade">
    <div id="accordion-v3" class="panel-group acc-v1">
        <?php
        $count = 0;
        foreach($commHelp['results'] as $data){?>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
...
<div id="settings" class="tab-pane fade">
    <div id="accordion-v4" class="panel-group acc-v1">
        <?php
        $count = 0;
        foreach($techSupp['results'] as $data){?>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
...
<!-- Tab Content 4 -->
    ...
    <a href="/faq/questions" class="btn-u btn-u-default btn-u-sm btn-block" style="text-align: center">See All Questions</a>
</div>
<!--/col-md-6-->
<!--End Tab v1-->
...
<div class="tab-v1">
    ...
    <div class="tab-content">
        ...
        <div id="tutData" class="tab-pane fade">
            <div id="accordion-v6" class="panel-group acc-v1">
                <?php
                $count = 0;
                foreach($sourceHelpq['results'] as $data){?>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
        ...
        <div id="tutHelp" class="tab-pane fade">
            <div id="accordion-v7" class="panel-group acc-v1">
                <?php
                $count = 0;
                foreach($commHelpq['results'] as $data){?>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
        ...
        <div id="tutAccount" class="tab-pane fade">
            <div id="accordion-v8" class="panel-group acc-v1">
                <?php
                $count = 0;
                foreach($techSuppq['results'] as $data){?>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
    ...
    <a href="/faq/tutorials" class="btn-u btn-u-default btn-u-sm btn-block" style="text-align: center">See All Tutorials</a>
</div>
<!--/col-md-6-->
<!-- End Popular Topics -->
</div>
...
<div class="row extra-support">
    ...
    <div class="col-md-6">
        ...
        <?php } else {?>
            ...
            <form method="post" action="/forms/scicrunch-forms/question.php?cid=0">
