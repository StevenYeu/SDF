...
function makeDistroChart(settings) {
    ...
    chart.settings = {
        ...
        margin: {top: 15, right: 60, bottom: 160, left: 50},
    ...
    function tooltipHover(groupName, metrics) {
        ...
        tooltipString += "<br\>Count: " + formatAsFloat(metrics.lengthh);
        return function () {
...
//            metrics.max = d3.max(values);
    ...
    !function prepareChart() {
        ...
        .style("font-weight", "bold")  
            ...
            .text("Workflow ID (number of cases docked)");
;
