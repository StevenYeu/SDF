<?php
    $col_text = "col-md-12";
    if($component->image) $col_text = "col-md-6";
?>
<style>
...
<div class="one-page <?php if($vars['editmode']) echo 'editmode' ?>">
    <div class="one-page-inner one-red"
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="<?php echo $col_text ?> p-styling">
                    <?php echo $component->text2 ?>
                    <?php if($component->icon2): ?>
                        <a class="btn-u btn-u-green one-page-btn" href="<?php echo $component->icon2 ?>" style="background:<?php echo '#' . $component->color2 ?>;color:<?php echo '#' . $component->color3 ?>">
                            <i class="<?php echo $component->icon1 ?>"></i> <?php echo $component->text3 ?>
                        </a>
                    <?php endif ?>
                </div>
                <?php if($component->image): ?>
                    <div class="col-md-6">
                        <img src="/upload/community-components/<?php echo $component->image ?>" class="img-responsive margin-bottom-10" alt="">
                    </div>
                <?php endif ?>
            </div>
        </div>
