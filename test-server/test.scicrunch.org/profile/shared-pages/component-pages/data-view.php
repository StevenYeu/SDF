...
$datas = $holder->getByComponent($arg3, $community->id, 0, 100);
                            ...
                            if (count($datas) > 0) {
                                foreach ($datas as $data) {
                                    ...
                                    if($community->id==0)
                                        ...
                                        // for some "icon1" values, pass it along 
                                    	if (($component->icon1 == 'challenge1') || ($component->icon1 == 'files1') || ($component->icon1 == 'challengeset1'))
                                            echo $data->dropdown($profileBase.'account/communities/'.$community->portalName, $component->icon1);
