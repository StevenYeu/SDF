...
<div class="container content <?php if ($vars['editmode']) echo 'editmode' ?>">
    ...
    <div class="row category margin-bottom-20">
        ...
        <?php if($component->text2): ?>
            <div class="col-md-4">
                <!-- Begin Section-Block -->
                <a class="twitter-timeline" data-height="500px" href="https://twitter.com/<?php echo $component->text2 ?>">Tweets by @<?php echo $component->text2 ?></a> <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
                <!-- End Section-Block -->
            </div>
        <?php endif ?>
    </div>
