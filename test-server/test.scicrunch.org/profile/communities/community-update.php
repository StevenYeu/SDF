        ...
        <div class="col-md-9">
            ...
            <form action="/forms/community-forms/edit-community.php?cid=<?php echo $community->id?>" method="post" class="sky-form create-form" enctype="multipart/form-data">
                ...
                <fieldset>
                    ...
                    <section>
                        <label class="label"><a href="http://www.google.com/analytics/">Google Analytics</a> Code</label>
                        <label class="input">
                            <i class="icon-append fa fa-question-circle"></i>
                            <input type="text" placeholder="Focus to view the tooltip" name="gacode" value="<?php echo $community->ga_code ?>">
                            <b class="tooltip tooltip-top-right">Your google analytics code for tracking community traffic</b>
                        </label>
                    </section>

                    <section>
                        <label class="label"><a href="http://mailchimp.com/">Mailchimp</a> API Key</label>
                        <label class="input">
                            <i class="icon-append fa fa-question-circle"></i>
                            <input type="text" placeholder="Focus to view the tooltip" name="mailchimp_api_key" value="<?php echo $community->mailchimp_api_key ?>">
                            <b class="tooltip tooltip-top-right">Your Mailchimp API key for automatically adding new members </b>
                        </label>
                    </section>
                    <section>
                        <label class="label"><a href="http://mailchimp.com/">Default Mailchimp</a> List ID</label>
                        <label class="input">
                            <i class="icon-append fa fa-question-circle"></i>
                            <input type="text" placeholder="Focus to view the tooltip" name="mailchimp_default_list" value="<?php echo $community->mailchimp_default_list ?>">
                            <b class="tooltip tooltip-top-right">ID of default list for community</b>
                        </label>
                    </section>
                ...
                <fieldset>
                    <section>
                        ...
                        <label class="select">
                            <i class="icon-append fa fa-question-circle"></i>
                            <select name="private">
                                <option value="0" <?php if ($community->private == 0) echo 'selected' ?>>Open To All</option>
                                <option value="1" <?php if ($community->private == 1) echo 'selected' ?>>Closed To All but Current Members</option>
                            </select>
                        </label>
                    </section>
                    <?php if($community->private === 1): ?>
                        <section>
                            <label class="label">Show front page to non-members</label>
                            <label class="select">
                                <i class="icon-append fa fa-question-circle"></i>
                                <select name="front_page_visible">
                                    <option value="0" <?php if ($community->front_page_visible == 0) echo 'selected' ?>>Don't allow non-members to see front page</option>
                                    <option value="1" <?php if ($community->front_page_visible == 1) echo 'selected' ?>>Allow non-members to see front page</option>
                                </select>
                            </label>
                        </section>
                    <?php endif ?>
                    <section>
                        ...
                        <div class="row">
                            <div class="col col-4">
                                <label class="label">Community Resources Name</label>
                                <label class="input">
                                    <i class="icon-append fa fa-question-circle"></i>
                                    <input type="text" placeholder="Focus to view the tooltip" name="search_name_comm_resources" value="<?php echo $community->search_name_comm_resources ?>">
                                    <b class="tooltip tooltip-top-right">Custom name for the community resources search pages</b>
                                </label>
                            </div>
                            <div class="col col-4">
                                <label class="label">More Resources Name</label>
                                <label class="input">
                                    <i class="icon-append fa fa-question-circle"></i>
                                    <input type="text" placeholder="Focus to view the tooltip" name="search_name_more_resources" value="<?php echo $community->search_name_more_resources ?>">
                                    <b class="tooltip tooltip-top-right">Custom name for the more resources search pages</b>
                                </label>
                            </div>
                            <div class="col col-4">
                                <label class="label">Literature Name</label>
                                <label class="input">
                                    <i class="icon-append fa fa-question-circle"></i>
                                    <input type="text" placeholder="Focus to view the tooltip" name="search_name_literature" value="<?php echo $community->search_name_literature ?>">
                                    <b class="tooltip tooltip-top-right">Custom name for the literature search pages</b>
                                </label>
                            </div>
                        </div>
                    </section>
