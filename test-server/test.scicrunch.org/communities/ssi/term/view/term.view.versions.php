<div class="tab-pane fade" id="versions">
    <div class="col-md-12" style="background: #f8f8f8;padding: 15px 15px;border-bottom: 1px solid #dedede;" ng-show="versions.length > 0">
        ...
        <fieldset>
            <p><strong>Label:</strong> {{versionInfo.label}}</p>
            <p>
                <strong>Curie:</strong> {{curiefyIlx(versionInfo.ilx)}} &nbsp;&nbsp;
