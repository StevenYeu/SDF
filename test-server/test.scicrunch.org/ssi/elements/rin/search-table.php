...
//$results = $search_manager->search($vars["q"], $search->per_page, $vars["page"], $search_options);
...
<div>
    ...
    <div class="col-md-2" id="left-nav-facets">
        ...
        <?php echo \helper\htmlElement("view-facets-rrid", Array("results" => $results, "search" => $search, "vars" => $vars)); ?>
    ...
    <div class="col-md-10">
        <div class="row">
            <div class="col-md-12">
                <a href="javascript:void(0)" class="switch-to-snippet"><button class="btn btn-default"><i class="fa fa-list"></i></button> Snippet view</a>
        ...
        <?php endif ?>
        <?php if($results->totalCount() == 0): ?>
            <?php echo $search->getResultText('table', array($results->totalCount(), $GLOBALS["notif_id"], $subscription_data["modified_time"]), NULL, $vars) ?>
        <?php else: ?>
                        ...
                        <tbody>
                            ...
                            <?php foreach($results as $i => $result): ?>
                                <?php
                                    ...
                                    unset($newVars["nif"]);
                                    $newVars['view'] = $nifid;
                                    $newVars['rrid'] = $result->getRRIDField("curie");
                                        ...
                                        <?php
                                            ...
                                            if ($fmt_value != "") {
                                                switch ($field_name->name) {
                                                    /*case "Name":    ## added unique id to the resource link -- Vicky-2019-2-4
                                                        $fmt_value = '<a href="'.$result->url($community)."?i=$idx".'">'.$fmt_value.'</a>';
                                                        break;*/
                                                    ...
                                                    case "Target Antigen":
                                                        ...
                                                        break;
                                                    /*case "Proper Citation":   ## modified proper citation -- Vicky-2019-1-23
                                                        $values = explode(" (", $fmt_value);
                                                        if (count($values) > 1) $fmt_value = "(".trim($values[0]).", ".$values[1];
                                                        break;*/
                                                    ...
                                                    case "Comments":
                                                        ...
                                                        break;
                                                    case "DOI":
                                                        $fmt_value = "<a target='_blank' href='https://dx.doi.org/".$fmt_value."'>".$fmt_value."</a>";
                                                        break;
                                                    case "External URL":
                                                        $fmt_value = "<a target='_blank' href='".$fmt_value."'>".$fmt_value."</a>";
                                                        break;
                                                }
                                            }

                                            if($count == 0) { // first column should be link to resource
                                                //$fmt_value = '<a href="' . $result->url($community) . '">' . $fmt_value . '</a>';
                                                ## added unique id to the resource link -- Vicky-2019-2-4
                                                $fmt_value = '<a href="'.$resource_report_url."&i=$idx".'">'.$fmt_value.'</a>';
                                            }
                                        ?>
                                        <?php if ($count > 6): ?>
                                                ...
                                                <span class="search-table-record-td">
                                                  ...
                                                  <?php if($count == 0):  ## added report and external link icons -- Vicky-2018-11-30 ?>
                                                      ...
                                                      <?php if($protocol_flag): ?>
                                                          <a href="<?php echo $resource_report_url . '&i=' . $idx ?> ">
                                                      <?php else: ?>
                                                          <a href="<?php echo $result->url($community) ?> ">
                                                      <?php endif ?>
                                                      <i class='fa fa-file-o'></i></a> Resource Report
                                                      <br>
                                                      ...
                                                      <?php if($result->getRRIDField("mentionCount") > 0): ## added mentions count -- Vicky-2019-9-15?>
                                                          ...
                                                          ?>
                                                          <br><i class='fa fa-line-chart'></i> <?php echo $mentionCount ?> mentions <span class="help-tooltip" data-name="mention-definition.html"></span>
                                                      <?php endif ?>
