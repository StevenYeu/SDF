<?php
    ...
    */
    ...
    $sub_data = array("1146"=>"BACE1a", "1470"=>"BACE1b");
    ...
    $chart = $_GET['chart'];
        ...
        for ($i=$valid_ligand_start; $i<=$valid_ligand_end; $i++) {
            if (($component == 1146) || ($component == 1470))
                $ligands[] = "BACE_" . $i;
            else
                $ligands[] = "CatS_" . $i;
        }
    ...
    $json_filter = "/php/d3r/gc4/combined/pose/json_filter.php?" . implode('&', $parameters);
...
<head>
    <meta charset="UTF-8">
    <title>GC4 Pose Prediction Method - RMSD</title>
...
<h1>Grand Challenge 4 - Pose Prediction Method - <?php echo $dataname; ?></h1>
