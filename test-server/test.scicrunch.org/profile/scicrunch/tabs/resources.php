<?php
$holder = new Resource();
$curated = $holder->getByCommunity(0, 'Curated', 0, 20);
$pending = $holder->getByCommunity(0, 'Pending', 0, 20);

$holder = new Resource_Type();
$types = $holder->getByCommunity(0);
?>
    ...
    <div class="panel panel-profile">
        <div class="panel-heading overflow-h">
            <h2 class="panel-title heading-sm pull-left"><i
                    class="fa fa-list-alt"></i>SciCrunch Resource Forms</h2>
                    ...
                    <table class="table table-hover">
                        ...
                        foreach($types as $type){
                            ...
                            echo '<div class="btn-group" style="margin-top:-4px">
                                ...
                                echo '<li><a href="'.$profileBase.'account/scicrunch/type/edit/'.$type->id.'"><i class="fa fa-cogs"></i> Edit Type</a></li>';
                            echo '<li><a href="'.$profileBase.'account/scicrunch/form/edit/'.$type->id.'"><i class="fa fa-list-alt"></i> Edit Form</a></li>';

                            echo '<li><a href="/forms/resource-forms/type-delete.php?id='.$type->id.'"><i class="fa fa-times"></i> Delete</a></li>
                                        </ul>
                                    </div>';
                            echo '</td>';
                        }
            ...
            <div class="panel panel-profile no-bg">
                ...
                <div id="scrollbar2" class="panel-body contentHolder">
                    ...
                    foreach ($curated as $data) {
                        ...
                        echo '<a href="'.$profileBase.'account/communities/' . $community->portalName . '/update/' . $data->id . '"><i style="font-size:20px;margin-top:5px;" class="fa fa-wrench pull-right"></i></a>';
        ...
        <div class="col-sm-6 md-margin-bottom-20">
            <div class="panel panel-profile no-bg">
                <div class="panel-heading overflow-h">
                    ...
                    <a href="<?php echo $profileBase?>account/communities/<?php echo $community->portalName ?>/insert/103"><i
                            class="fa fa-plus-circle pull-right"></i></a>
                </div>
                <div id="scrollbar2" class="panel-body contentHolder">
                    <?php
                    foreach ($pending as $data) {
                        echo '<div class="profile-event">';
                        if($community->id==0)
                            echo '<a href="'.$profileBase.'browse/resourcesedit/' . $data->rid . '/edit"><i style="font-size:20px;margin-top:5px;" class="fa fa-wrench pull-right"></i></a>';
                        else
                            echo '<a href="'.$profileBase.'about/registry/'.$data->rid.'/edit"><i style="font-size:20px;margin-top:5px;" class="fa fa-wrench pull-right"></i></a>';
                        echo '<div class="overflow-h" style="display: inline-block">';
                        echo '<h3 class="heading-xs"><a href="#">' . $data->columns['Resource Name'] . '</a></h3>';
                        echo '</div>';
                        echo '</div>';
