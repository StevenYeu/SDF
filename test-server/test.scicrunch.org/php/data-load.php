...
$datas = $data->getByComponent($comp,$cid,0,10);
$data->component = $comp;
$data->id = 0;
?>

<div class="close light">X</div>
<form method="post" action="/forms/component-forms/body-data-add.php?cid=<?php echo $cid ?>&component=<?php echo $comp ?>"
      id="header-component-form" class="sky-form" enctype="multipart/form-data">
    <?php echo $data->getDataForm($datas); ?>
    <footer>
