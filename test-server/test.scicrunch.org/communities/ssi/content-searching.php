    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            foreach ($results['results'] as $data) {
                ...
                echo '<h3><a href="/'.$community->portalName.'/about/'.$compList[$data->component]['page'].'/' . $data->id . '">' . Component::macroExpand($data->title, Array("community" => $community)) . '</a></h3>';
                ...
                echo '<p>' . Component::macroExpand($data->description, Array("community" => $community)) . '</p>';
