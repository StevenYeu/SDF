...
<div class="container margin-bottom-50" style="margin-top: 50px">
    <form action="/forms/resource-forms/resource-edit.php?rid=<?php echo $resource->rid ?>&cid=<?php echo $community->id?>" method="post" id="sky-form"
          class="sky-form">
        <!-- Datepicker Forms -->
        ...
        <?php } elseif($_SESSION['user']->role>0 || $_SESSION['user']->levels[$community->id]>1){ ?>
            <fieldset>
