                            ...
                            <div class="overflow-h" style="display: block">
                                <h3 class="heading-xs"><?php echo $component->getName() ?>
                                    ...
                                    if($component->getDynamicStatus()){
                                        if(in_array($component->component, ["15", "16"])) {
                                            echo '<a href="'.$profileBase.'account/communities/'.$community->portalName.'/dynamic/151" class="pull-right"><i class="fa fa-file-text-o" title="Edit image"></i></a>';
                                            echo '<a href="'.$profileBase.'account/communities/'.$community->portalName.'/dynamic/150" class="pull-right"><i class="fa fa-file-text-o" title="Edit slide"></i></a>';
                                        }
                                        else echo '<a href="'.$profileBase.'account/communities/'.$community->portalName.'/dynamic/'.$component->component.'" class="pull-right"><i class="fa fa-file-text-o"></i></a>';
                                    }
                                    ?>
                                </h3>
                            </div>
