...
<div class="purchase <?php if($vars['editmode']) echo 'editmode'?>">
    <div class="container">
        <div class="row" <?php if($firstRow): ?>style="border: 2px solid #<?php echo $component->color1 ?>; padding: 10px"<?php endif ?>>
            <div class="col-md-9 animated fadeIn">
                <span><?php echo $component->text1?></span>
                <p><?php echo $component->text2?></p>
            </div>
            <div class="col-md-3 btn-buy animated fadeIn">
                <a <?php if($firstRow) echo 'target="_blank"'; ?> href="<?php echo $component->image?>" class="btn-u btn-u-lg goto-btn"><i class="<?php echo $component->icon1?>"></i> <?php echo $component->text3?></a>
            </div>
        </div>
    </div>
