            ...
            <div class="row">
                <div class="col-sm-8">
                    <div class="profile-blog" style="padding:5px;">
                        <a href="/forms/clear-cache.php" class="btn-u">Clear Search Cache</a>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="profile-blog" style="padding:5px;">
        ...
        <div class="col-sm-6">
            <div class="panel panel-profile no-bg">
                <div class="panel-heading overflow-h">
                    ...
                    <a href="<?php echo $profileBase?>account/scicrunch/users?nobnnd=on"><i class="fa fa-cog pull-right"></i></a>
                </div>
                        ...
                        foreach ($users as $user) {
                            ...
                            <div class="profile-post <?php echo $colors[$user->role] ?>" style="position: relative">
                                ...
                                <div class="profile-post-in" style="margin-left: 10px;;margin-right: 60px">
                                    <h3 class="heading-xs"><?php echo $user->getFullName() ?></h3>
                ...
                <a href="<?php echo $profileBase?>account/scicrunch/users?nobnnd=on" class="btn-u btn-u-dark" style="width:100%;text-align: center;margin-top: 10px;">SEE ALL</a>
            </div>
        </div>
        <!--End Profile Post-->
            ...
            <div class="panel panel-profile no-bg">
                ...
                <div id="scrollbar2" class="panel-body contentHolder">
                    ...
                    foreach ($recent as $source) {
                        ...
                        echo '<h3 class="heading-xs">' . $source->getTitle() . '</h3>';
                        echo '</div>';
                        echo '</div>';
                    }
                    ?>
