            ...
            <div class="panel-heading">
                ...
                <label style="padding-right:30px" class="pull-right">Type:
                    <select name="-headerSelect" class="header-select" style="color:#000;">
                        ...
                        <option
                            value="float-no-logo" <?php if ($component->component == 4) echo 'selected' ?>>
                            float-no-logo
                        </option>
                    </select>
                </label>
        ...
        <div class="panel panel-dark">
            ...
            <div class="panel-body">
                <fieldset>
                    ...
                    echo $component->formObjects('color','color3','Save This Search Color','The background color of the save this search button');
                    ?>
                </fieldset>
            </div>
        </div>
            ...
            <div class="panel-heading">
                ...
                <label class="pull-right">Type:
                    <select name="-footerSelect" class="footer-select" style="color:#000;">
                        ...
                        <option value="dark" <?php if($component->component==90) echo 'selected'?>>Dark</option>
                        <option value="light" <?php if($component->component==91) echo 'selected'?>>Light</option>
                    </select>
                </label>
            </div>
            <div class="panel-body">
