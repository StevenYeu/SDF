...
$sourcesSchemas = array();
foreach ($sources as $source) 
{
    $sourcesSchemas[] = SchemaGeneratorSources::generateTableViewReference($source, $community->portalName);
}
...
<div class="container content">
    <div class="row">
        <div class="col-md-9">
            <div class="tab-v5">
                <?php foreach ($sourcesSchemas as $schema) { ?>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="sources">
                        ...
                        foreach ($sourceNames as $view => $name) {
                            ...
                            else $imageSrc = '/images/scicrunch.png';
                    ...
                    <ul class="list-inline">'.
                        '<li><img src="/images/scicrunch.png" style="height:15px;width:15px;padding:0;margin:0;margin-top:-5px;border:0px;background:inherit"/>'.
                            ' <a href="/' . $community->portalName . '/data/source/' . $view . '/search?q=%2A&l=">'.number_format($sources[$view]->data) . ' records'. 
                            '</a>'.
                        '</li>';
                        if (isset($_SESSION['user']) && $_SESSION['user']->levels[$community->id] > 1) {
                                if ($snippet->hasSnippet($community->id, $view)) {
