...
$has_challenges = $holder->communityHasChallenge($community->id);
...
<ul class="nav nav-tabs margin-bottom-20 tut-nav">
    ...
    <!--<li class="page2-tab <?php if($section=='labs') echo 'active' ?> tut-appear"><a href="#labs" data-toggle="tab">Labs</a></li>-->
    <!--<li class="page2-tab <?php if($section=='datasets') echo 'active' ?> tut-appear"><a href="#datasets" data-toggle="tab">Datasets</a></li>-->
    <?php
        if ($has_challenges) {
    ?>
            <li class="page2-tab <?php if ($section == 'challengeadmin') echo 'active' ?> tut-challengeadmin"><a
                    href="#challengeadmin" data-toggle="tab">Challenge Admin</a></li>
    <?php
        }
    ?>
...
<?php //include 'tabs/labs.php';?>
<?php //include 'tabs/datasets.php';?>
<?php if($has_challenges) include 'tabs/challengeadmin.php';?>
