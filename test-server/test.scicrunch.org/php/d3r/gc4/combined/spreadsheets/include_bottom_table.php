...
<table id="gc4results" class="display" cellpadding="2" cellspacing="0">
...
<?php elseif ($include_method == 'noties_freeenergy'): ?>
<tr class="tabs">
    <th>Receipt ID</th>
    <th>Submitter Name</th>
    <th>PI/Group Name</th>
...
*/            
            echo "<td>" . $line['median pose 1 rmsd'] . "</td>\n";
            echo "<td>" . $line['mean pose 1 rmsd'] . "</td>\n";
            echo "<td>" . $line["std pose 1 rmsd"] . "</td>\n";
        } elseif (   
        ...
        } elseif (($include_method == 'noties_freeenergy')
        ) {
            echo "<td>" . $line['Kendalls Tau'] . "</td>\n";
            echo "<td>" . $line['Kendalls Tau Error'] . "</td>\n";
            echo "<td>" . $line["Spearman's Rho"] . "</td>\n";
        ...
        if (substr($include_method, 0, 4) !== 'pose')
            echo "<td>" . $line['challenge_type'] . "</td>\n";
