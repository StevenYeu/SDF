...
<style>
    ...
    .header-v5 .navbar-default .navbar-nav > li:hover > a,.header-v5 .navbar-default .navbar-nav > .active > a {
    ...
    .header-v5 .dropdown-menu .active > a, .header-v5 .dropdown-menu li > a:hover,.header-v5 .dropdown-menu li.dropdown-submenu:hover > a {
        background: <?php echo '#'.$component->color1;?>;
    }
    .header-v5 .dropdown-menu {
        border-top:2px solid <?php echo '#'.$component->color1?>;
    }
    <?php } ?>
...
<div
    class="header-v5 header-static <?php if ($vars['editmode']) echo 'editmode' ?>" <?php echo 'style="z-index:99"' ?>>
<!-- Topbar v3 -->
<div class="topbar-v3" <?php if($vars['editmode']) echo 'style="position:fixed;top:0;left:0;z-index:110;width:100%"' ?>>
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <!-- Topbar Navigation -->
            ...
            <div class="col-sm-6">
                <ul class="list-inline right-topbar pull-right top-v1-data">
                    ...
                    <li><i class="search2 fa fa-info-circle tutorial-header-btn"></i></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/<?php echo $community->portalName ?>">
                <img class="community-logo" src="/upload/community-logo/<?php echo $community->logo ?>"/><span
                    style="font-size: 28px"><?php echo $community->name ?></span>
            </a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <?php if ($community->resourceView) { ?>
                    <li class="<?php if ($tab == 1) echo 'active' ?> dropdown resource-tab">
                        ...
                        $newVars["type"] = NULL;
                        ?>
                        <a href="<?php echo $search->generateURL($newVars) ?>" class="joyride-community-resources" data-toggle="dropdown"><?php echo Community::getSearchNameCommResources($community) ?></a>
                        <ul class="dropdown-menu">
                            <?php
                            $number = 0;
                ...
                <?php if ($community->dataView) { ?>
                    <li class="<?php if ($tab == 2) echo 'active' ?> data-tab">
                        ...
                        $newVars['page'] = 1;
                        ?>
                        <a href="<?php echo $search->generateURL($newVars) ?>" class="joyride-more-resources" data-toggle="dropdown"><?php echo Community::getSearchNameMoreResources($community) ?></a>
                    </li>
                <?php } ?>
                <!-- End Job Pages -->
                ...
                <?php if ($community->literatureView) { ?>
                    <li class="<?php if ($tab == 3) echo 'active' ?> lit-tab">
                        ...
                        $newVars["type"] = NULL;
                        ?>
                        <a href="<?php echo $search->generateURL($newVars) ?>" class="joyride-literature" data-toggle="dropdown"><?php echo Community::getSearchNameLiterature($community) ?></a>
                    </li>
                <?php } ?>

                <?php if (isset($_SESSION['user'])) { ?>
                    <li class="<?php if ($tab == 4) echo 'active' ?> dropdown account-tab">
                        <a href="javascript:void(0);" data-toggle="dropdown">My Account <?php if($n_notifs > 0) echo \helper\htmlElement("notification-bubble", Array("text" => $n_notifs)) ?></a>
                        <ul class="dropdown-menu">
