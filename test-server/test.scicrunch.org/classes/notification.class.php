...
class Notification extends Connection {
    ...
    public $icons = array(
        ...
        'add-term-notification' => 'icon-bg-green fa fa-bell-o',
        'delete-term-notification' => 'icon-bg-green fa fa-bell-slash-o',
        'update-term-notification' => 'icon-bg-green fa fa-cog',
