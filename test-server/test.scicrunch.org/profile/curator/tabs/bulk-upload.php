...
<div class="panel">
    <div class="panel-heading">
        <h1>Bulk Resource Uploader</h1>
        <p><b>Instructions</b></p>
        <ul>
            <li><a href="/php/bulk-upload-csv-template.php" style="color:#72c02c;">Download Template File</a>
            <li>Open file in Microsoft Excel or Google Sheets</li>
            <li>Specify action (adding resource, updating resource, no action) in the <b>Action</b> column with <b>add</b>, <b>update</b>, <b>skip</b> respectively.</li>
            <li>Required columns to <b>add resource</b>: Resource Name, Description, Resource URL</li>
            <li>Required columns to <b>update resource</b>: Resource ID (eg. SCR_123456)</li>
            <li>The Defining Citation column must be formatted correctly (eg. PMID:22434839, DOI:10.1126/science.1157784)</li>
            <li>To delete a field, write the word <b>delete</b> to the column you want deleted.</li>
            ...
            <li>After Uploading the file, you should see the <b>status</b> of the action on the second to last column of the preview table along with the Resource ID if it is a newly added resource.</li>
            <li>After Uploading the file, change all the <b>Action</b> columns to <b>skip</b> to prevent adding duplicates the next time. Also remember to <b>include the new Resource ID</b> of newly added resources for easy updating in the future.</li>
        </ul>
    </div>
    <div class="panel-body">
        <div class="container" ng-app="bulkUploadApp" ng-cloak>
...
<script src="/js/curator-bulk-upload.js"></script>
<script>
